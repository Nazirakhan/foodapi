...
def image_upload_url(recipe_id):
    """Create and return an image upload UPL."""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 115,
            'price': Decimal('5.50'),
            'ingredients': [{'name': 'Chicken'}, {'name': 'Curd'}],
        }
        res = self.client.post(RECIPE_URL, payload, format='json')
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Paneer')
        payload = {
            'title': 'Paneer Bhurji',
            'time_minutes': 60,
            'price': Decimal('4.50'),
            'ingredients': [{'name': 'Paneer'}, {'name': 'Cream'}],
        }
        res = self.client.post(RECIPE_URL, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Biryani')
        r2 = create_recipe(user=self.user, title='Baingan Varta')
